...
# 1. csv 파일 불러오기
df = pd.read_csv("c:/source/pythonsource/dataScience/data/convenience_sales.csv", encoding="utf-8-sig")
print(df)
# 엑셀에서 만들거나 저장한 한글 CSV 파일을 파이썬으로 불러올 때는 encoding="utf-8-sig"를 사용하는 것이 한글 깨짐과 컬럼명 오류를 방지
